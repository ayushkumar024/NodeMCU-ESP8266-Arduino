...
uint8_t pin_led = 5; //Utility LED PIN
uint8_t pin_con = 5; //Status LED PIN
 ...
 */
  ...
  if (mdns.begin("ayushkumar", WiFi.localIP()))
  {
    Serial.println("Responder started for local IP : ayushkumar.local");
  }
